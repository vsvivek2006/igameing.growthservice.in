...
export const Model3CaseStudies: React.FC = () => {
  ...
  return (
    <section id="casestudies" className="relative py-20 lg:py-32 bg-[#050505] text-white border-b border-white/10 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="p-8 sm:p-10 lg:p-12 rounded-3xl bg-[#0a0a14] border border-white/15 shadow-2xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-2xl sm:text-3xl font-black text-white font-heading mb-6 leading-tight">
                  {current.title}
                </h3>
            ...
            <div className="lg:col-span-5 flex flex-col gap-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                {current.metrics.map((m, mIdx) => (
                  <div
                    key={mIdx}
                    className="p-5 rounded-2xl bg-[#0e0e1c] border border-white/10 shadow-lg relative group hover:border-amber-400/40 transition-colors"
                  >
              ...
              <div className="p-5 rounded-2xl bg-[#0e0e1c] border border-white/10">
