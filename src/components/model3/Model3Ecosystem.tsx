...
export const Model3Ecosystem: React.FC = () => {
  const pillars = [
    {
      pillarNumber: '01',
  ...
  return (
    <section id="ecosystem" className="relative py-20 lg:py-32 bg-[#08080f] text-white border-b border-white/10 overflow-hidden">
      {/* Background Lighting */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          {pillars.map((pillar) => {
            ...
            return (
              <div
                ...
                className={`relative rounded-3xl bg-[#0d0d18] border ${pillar.borderColor} p-8 flex flex-col justify-between shadow-2xl transition-all duration-300 group hover:-translate-y-1 ${pillar.glowColor}`}
              >
                {/* Pillar Header */}
                <div>
        ...
        <div className="mt-12 p-6 rounded-2xl bg-gradient-to-r from-purple-950/40 via-[#0d0d18] to-amber-950/30 border border-white/10 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
