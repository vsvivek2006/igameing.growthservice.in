...
export const Model3FinalCTA: React.FC = () => {
  return (
    <section className="relative py-24 lg:py-36 bg-[#050505] text-white border-b border-white/10 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        ...
        {/* Closing Headline */}
        <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight text-white font-heading mb-6 leading-[1.1]">
        ...
        <div className="inline-flex flex-wrap items-center justify-center gap-6 p-4 rounded-2xl bg-[#0a0a14] border border-white/10 text-xs text-slate-400">
