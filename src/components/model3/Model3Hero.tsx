...
export const Model3Hero: React.FC = () => {
  return (
    <section className="relative min-h-[92vh] pt-28 pb-16 lg:pt-36 lg:pb-24 bg-[#050505] overflow-hidden flex items-center border-b border-white/10">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            {/* Main Punch Headline */}
            <h1 className="text-4xl sm:text-5xl xl:text-6xl font-black tracking-tight text-white font-heading leading-[1.08] mb-6">
              Rank Higher. <br />
          ...
          <div className="lg:col-span-6 relative flex items-center justify-center">
            ...
            <div className="w-full relative">
              ...
              <div className="absolute top-2 left-0 sm:-left-4 z-20 hidden sm:block p-3.5 rounded-2xl bg-[#0d0d18]/85 border border-purple-500/30 backdrop-blur-xl shadow-2xl shadow-purple-950/50 hover:scale-105 transition-transform duration-300">
              ...
              <div className="absolute top-6 right-0 sm:-right-4 z-20 hidden sm:block p-3.5 rounded-2xl bg-[#0d0d18]/85 border border-amber-500/30 backdrop-blur-xl shadow-2xl shadow-amber-950/40 hover:scale-105 transition-transform duration-300">
              ...
              <div className="absolute bottom-2 left-0 sm:-left-4 z-20 hidden sm:block p-3.5 rounded-2xl bg-[#0d0d18]/85 border border-cyan-500/30 backdrop-blur-xl shadow-2xl shadow-cyan-950/40 hover:scale-105 transition-transform duration-300">
                <div className="flex items-center gap-2 mb-2">
                  <ShieldCheck className="w-4 h-4 text-cyan-400" />
                  <span className="text-[11px] font-bold uppercase tracking-wider text-slate-300">
                    Core Web Vitals
                  </span>
                  <span className="ml-auto text-[10px] font-black text-cyan-300 bg-cyan-500/10 px-1.5 py-0.5 rounded border border-cyan-500/20">
                    98 A+
                  </span>
                </div>
              ...
              <div className="absolute bottom-6 right-0 sm:-right-4 z-20 hidden sm:block p-3.5 rounded-2xl bg-[#0d0d18]/85 border border-indigo-500/30 backdrop-blur-xl shadow-2xl shadow-indigo-950/40 hover:scale-105 transition-transform duration-300">
                <div className="flex items-center gap-2 mb-2">
