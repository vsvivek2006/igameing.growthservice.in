...
export const Model3Pricing: React.FC = () => {
  const tiers = [
    {
      name: 'SEO Foundation',
      ...
      ctaHref: 'https://wa.me/919999999999?text=Hello%20iGaming%20Growth%20Team%2C%20I%20am%20interested%20in%20the%20SEO%20Foundation%20Tier%20starting%20at%2035K.',
    ...
    },
    {
      ...
      ctaHref: 'https://wa.me/919999999999?text=Hello%20iGaming%20Growth%20Team%2C%20I%20want%20to%20deploy%20the%20Growth%20Engine%20for%20our%20platform.',
    ...
    },
    {
      ...
      ctaHref: 'https://wa.me/919999999999?text=Hello%20iGaming%20Growth%20Team%2C%20I%20am%20inquiry%20about%20Enterprise%20SEO%20and%20Scale.',
      buttonStyle: 'bg-white/10 hover:bg-white/20 text-white border border-white/20',
    },
  ];

  return (
    <section id="pricing" className="relative py-20 lg:py-32 bg-[#050505] text-white border-b border-white/10 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch mb-12">
          {tiers.map((tier, idx) => (
            <div
              key={idx}
              className={`relative rounded-3xl bg-[#0a0a14] border ${tier.border} p-8 sm:p-9 flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 ${
                tier.highlighted ? 'bg-[#0d0d1a]' : ''
              }`}
            >
              {/* Highlighted Ribbon */}
              {tier.highlighted && (
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                  <span className="text-[10px] font-mono font-black uppercase tracking-widest px-3.5 py-1 rounded-full bg-gradient-to-r from-amber-400 to-yellow-400 text-slate-950 shadow-md shadow-amber-400/40">
                    {tier.badge}
                  </span>
                </div>
              )}
