...
export const Model3Process: React.FC = () => {
  const steps = [
    {
      number: '01',
  ...
  return (
    <section id="process" className="relative py-20 lg:py-32 bg-[#050505] text-white border-b border-white/10 overflow-hidden">
        ...
        <div className="space-y-6 relative">
          {steps.map((step, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-7 sm:p-8 rounded-3xl bg-[#0a0a14] border border-white/10 shadow-xl flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 group hover:border-amber-400/40 transition-all duration-300"
              >
                {/* Number & Icon */}
                <div className="flex items-center gap-5 shrink-0">
                  <div className="text-3xl sm:text-4xl font-black text-amber-400/30 group-hover:text-amber-400 font-mono transition-colors">
                    {step.number}
                  </div>
