...
export const Model3TrustStrip: React.FC = () => {
  const capabilities = [
  ...
  return (
    <div className="relative bg-[#08080c] border-b border-white/10 py-5 overflow-hidden">
      {/* Subtle edge fade overlays for continuous horizontal appearance */}
      <div className="absolute left-0 top-0 bottom-0 w-12 bg-gradient-to-r from-[#08080c] to-transparent z-10 pointer-events-none" />
      <div className="absolute right-0 top-0 bottom-0 w-12 bg-gradient-to-l from-[#08080c] to-transparent z-10 pointer-events-none" />
