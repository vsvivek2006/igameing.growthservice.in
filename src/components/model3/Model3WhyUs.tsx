...
export const Model3WhyUs: React.FC = () => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {differentiators.map((d, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-7 rounded-3xl bg-[#0d0d18] border border-white/10 shadow-xl flex flex-col justify-between group hover:border-amber-400/40 transition-all duration-300 hover:-translate-y-1"
              >
                <div>
