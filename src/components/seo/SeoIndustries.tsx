...
export const SeoIndustries: React.FC = () => {
  const industries = [
    {
  ...
  return (
    <section id="industries" className="relative py-20 lg:py-32 bg-model3-panel text-white border-b border-white/10 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {industries.map((ind, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`p-7 rounded-3xl bg-model3-deep border ${ind.borderAccent} shadow-2xl flex flex-col justify-between group transition-all duration-300 hover:-translate-y-1.5`}
              >
                <div>
