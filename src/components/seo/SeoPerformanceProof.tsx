...
export const SeoPerformanceProof: React.FC = () => {
  ...
  return (
    <section id="proof" className="relative py-20 lg:py-32 bg-model3-base text-white border-b border-white/10 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-12">
          {/* Metric 1 */}
          <div className="p-6 rounded-2xl bg-model3-surface border border-purple-500/20 shadow-xl shadow-purple-950/20 relative group hover:border-purple-500/40 transition-all duration-300">
            ...
            <div className="text-4xl lg:text-5xl font-extrabold text-white font-heading mb-2">
              90.4K
            </div>
          ...
          {/* Metric 2 */}
          <div className="p-6 rounded-2xl bg-model3-surface border border-amber-500/20 shadow-xl shadow-amber-950/20 relative group hover:border-amber-500/40 transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-400">
                Total Impressions
              </span>
          ...
          {/* Metric 3 */}
          <div className="p-6 rounded-2xl bg-model3-surface border border-cyan-500/20 shadow-xl shadow-cyan-950/20 relative group hover:border-cyan-500/40 transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-400">
                Average CTR
              </span>
          ...
          {/* Metric 4 */}
          <div className="p-6 rounded-2xl bg-model3-surface border border-emerald-500/20 shadow-xl shadow-emerald-950/20 relative group hover:border-emerald-500/40 transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-400">
                Average Position
              </span>
        ...
        <div className="rounded-3xl bg-model3-panel border border-white/15 p-6 sm:p-8 lg:p-10 shadow-2xl shadow-black/80">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-6">
            <div className="p-4 rounded-xl bg-purple-950/20 border border-purple-500/30">
              ...
              <div className="text-2xl font-extrabold text-white font-mono mt-1">90.4K</div>
            ...
            <div className="p-4 rounded-xl bg-amber-950/20 border border-amber-500/30">
              ...
              <div className="text-2xl font-extrabold text-white font-mono mt-1">195.2K</div>
            ...
            <div className="p-4 rounded-xl bg-cyan-950/20 border border-cyan-500/30">
              ...
              <div className="text-2xl font-extrabold text-white font-mono mt-1">46.4%</div>
            ...
            <div className="p-4 rounded-xl bg-emerald-950/20 border border-emerald-500/30">
              ...
              <div className="text-2xl font-extrabold text-white font-mono mt-1">1.9</div>
