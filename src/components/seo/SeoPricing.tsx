  ...
  const tiers = [
    {
      ...
      price: '₹35,000',
      period: '/ month',
      priceSubtitle: 'Continuous organic ranking sprint',
      highlighted: false,
      border: 'border-white/10 hover:border-purple-500/40',
      description:
        'Technical crawling, high-intent keyword clustering, entity schema graphs, and active monthly ranking telemetry.',
      deliverables: [
        'End-to-end technical SEO architecture audit',
        'High-intent commercial keyword clustering',
        'On-page semantic optimization & schema integration',
        'Google Search Console verified telemetry setup',
        'Crawl budget & Core Web Vitals optimization',
        '6–8 High-authority niche contextual backlink placements',
        'Bi-weekly performance & SERP rank reporting',
      ],
      ctaText: 'Start Monthly SEO (₹35K)',
      ctaHref: 'https://wa.me/917654928455?text=Hello%20iGaming%20Growth%20Team%2C%20I%20am%20interested%20in%20the%20SEO%20Monthly%20Sprint%20starting%20at%2035K.',
      buttonStyle: 'bg-white/10 hover:bg-white/20 text-white border border-white/20',
    },
    {
      name: '3-Month Rank Sprint',
      badge: '★ GUARANTEED RANK IN 3 MONTHS',
      price: '₹1,00,000',
      period: 'one-time',
      priceSubtitle: 'Guaranteed top ranking within 90 days',
      highlighted: true,
      border: 'border-amber-400/60 shadow-2xl shadow-amber-500/20',
      description:
        'Intensive one-time sprint engineered to rank your platform on Google first page in 3 months with complete topical authority.',
      deliverables: [
        'Guaranteed top SERP rank within 3-month (90-day) window',
        'Full topical authority graph (Cricket ID, Casino, Betting)',
        '15+ High-tier editorial authority backlink placements',
        'Aggressive Core Web Vitals & indexing speed acceleration',
        'Competitor SERP gap analysis & keyword intercept',
        'Entity Schema graphs & Google Knowledge Panel alignment',
        'Dedicated senior search engineer & weekly sprint calls',
        'Guaranteed milestone delivery or free continued optimization',
      ],
      ctaText: 'Claim 3-Month Rank Sprint',
      ctaHref: 'https://wa.me/917654928455?text=Hello%20iGaming%20Growth%20Team%2C%20I%20want%20to%20claim%20the%203-Month%20SEO%20Ranking%20Sprint%20(1%20Lakh).',
