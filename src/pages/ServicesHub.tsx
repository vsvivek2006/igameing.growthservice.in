  ...
  return (
    <>
      ...
      <section className="relative bg-navy-950 bg-hero-atmosphere text-white overflow-hidden border-b border-navy-800/80">
        ...
        <div className="absolute top-0 right-1/3 w-[500px] h-[400px] rounded-full bg-purple-600/10 blur-[100px] pointer-events-none" />
        ...
        <Container className="relative z-10">
          <div className="max-w-2xl mx-auto text-center space-y-6">
            ...
            <h2 className="type-h2 text-white">
              Not Sure Which Discipline Fits Your Architecture?
            </h2>
            <p className="text-slate-300 text-sm leading-relaxed max-w-xl mx-auto">
              Share your current platform state, target market, and indexing goals. We'll identify the highest-leverage starting point for your competitive profile.
            </p>
